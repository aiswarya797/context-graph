...
class ArtifactValidityTests(unittest.TestCase):
    def attempt(
        ...
        *,
        ...
        run_root = root / "codex-codegraph-smoke-fixture"
        ...
        index_record = {"task_id": "task", "identity": {"identity_sha256": "b" * 64}}
                ...
                "records": [
                    {
                        ...
                        "sha256": hashlib.sha256(index_record_path.read_bytes()).hexdigest(),
                    }
                ]
            },
