...
def compare_runs(
    ...
    *,
    ...
    if baseline_manifest.get("arm") != "codex-baseline" or treatment_manifest.get("arm") != "codex-codegraph-enriched":
    ...
    result = {
        "schema_version": "codex-codegraph-enriched-comparison-v1",
        "matched": True,
